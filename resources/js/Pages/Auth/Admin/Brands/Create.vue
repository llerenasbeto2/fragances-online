...
onMounted(() => {
    if (props.isUpdating && props.brand) {
        form.name     = props.brand.name;
        form.country  = props.brand.country  ?? '';
    ...
    <div class="min-h-screen bg-amber-50 dark:bg-neutral-800 py-8 transition-colors duration-300">
        <div class="max-w-2xl mx-auto px-4">
            <div class="bg-amber-100 dark:bg-gray-800 rounded-lg shadow-md p-8 transition-colors duration-300">
                <h2 class="text-2xl font-bold mb-6 text-black dark:text-white">{{ isUpdating ? 'Editar' : 'Nueva' }} Marca</h2>
                ...
                <form @submit.prevent="submit" class="space-y-4">
                    ...
                    <div>
                        <label class="block text-black dark:text-white mb-2 font-medium">País</label>
                        <input 
                    ...
                    <div>
                        <label class="block text-black dark:text-white mb-2 font-medium">URL del Logo</label>
                        <input 
                        ...
                        <div v-if="form.logo_url" class="mt-2">
                            ...
                            <img :src="form.logo_url" class="h-16 w-16 object-cover rounded-full border border-amber-200 dark:border-gray-700" alt="Vista previa">
                        </div>
                    </div>
